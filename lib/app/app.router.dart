...
class Routes {
  ...
  static const adminMenuItemView = '/admin-menu-item-view';
...
class StackedRouter extends _i1.RouterBase {
  final _routes = <_i1.RouteDef>[
    ...
    _i1.RouteDef(
      Routes.adminMenuItemView,
      page: _i22.AdminMenuItemView,
    ),
  ];
    ...
    _i21.AdminMenuCategoryView: (data) {
      ...
      return _i23.MaterialPageRoute<dynamic>(
        builder: (context) => _i21.AdminMenuCategoryView(
            initCategory: args.initCategory,
            catIndex: args.catIndex,
            key: args.key),
        settings: data,
      );
    },
    _i22.AdminMenuItemView: (data) {
      final args = data.getArgs<AdminMenuItemViewArguments>(nullOk: false);
      return _i23.MaterialPageRoute<dynamic>(
        builder: (context) =>
            _i22.AdminMenuItemView(initItem: args.initItem, key: args.key),
        settings: data,
      );
    },
  };
...
class AdminMenuCategoryViewArguments {
  ...
  @override
  String toString() {
    return '{"initCategory": "$initCategory", "catIndex": "$catIndex", "key": "$key"}';
  }

  @override
  bool operator ==(covariant AdminMenuCategoryViewArguments other) {
    if (identical(this, other)) return true;
    return other.initCategory == initCategory &&
  ...
  @override
  int get hashCode {
    return initCategory.hashCode ^ catIndex.hashCode ^ key.hashCode;
  }
}

class AdminMenuItemViewArguments {
  const AdminMenuItemViewArguments({
  ...
  @override
  String toString() {
    return '{"initItem": "$initItem", "key": "$key"}';
  }

  @override
  bool operator ==(covariant AdminMenuItemViewArguments other) {
    if (identical(this, other)) return true;
    return other.initItem == initItem && other.key == key;
  }

  @override
  int get hashCode {
    return initItem.hashCode ^ key.hashCode;
  }
}
...
extension NavigatorStateExtension on _i29.NavigationService {
  ...
  Future<dynamic> navigateToAdminMenuCategoryView({
    ...
    return navigateTo<dynamic>(Routes.adminMenuCategoryView,
        arguments: AdminMenuCategoryViewArguments(
            initCategory: initCategory, catIndex: catIndex, key: key),
        id: routerId,
        preventDuplicates: preventDuplicates,
        parameters: parameters,
        transition: transition);
  ...
  Future<dynamic> navigateToAdminMenuItemView({
    ...
    return navigateTo<dynamic>(Routes.adminMenuItemView,
        arguments: AdminMenuItemViewArguments(initItem: initItem, key: key),
        id: routerId,
        preventDuplicates: preventDuplicates,
        parameters: parameters,
        transition: transition);
  ...
  Future<dynamic> replaceWithAdminMenuItemView({
    ...
    return replaceWith<dynamic>(Routes.adminMenuItemView,
        arguments: AdminMenuItemViewArguments(initItem: initItem, key: key),
        id: routerId,
        preventDuplicates: preventDuplicates,
        parameters: parameters,
