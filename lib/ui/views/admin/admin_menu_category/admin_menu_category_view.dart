...
class AdminMenuCategoryView extends StackedView<AdminMenuCategoryViewModel> {
  const AdminMenuCategoryView(
      {required this.initCategory, required this.catIndex, Key? key})
      : super(key: key);
                    ...
                    child: !viewModel.isBusy
                        ? ReorderableListView.builder(
                            ...
                            itemBuilder: (context, index) => ListTile(
                              leading: Icon(viewModel
                                          .items[index].displayData?.isActive ??
                                      true
                                  ? Icons.visibility
                                  : Icons.visibility_off),
                              ...
                              onTap: () =>
                                  viewModel.onItemTap(viewModel.items[index]),
  ...
  AdminMenuCategoryViewModel viewModelBuilder(
    BuildContext context,
      ...
      AdminMenuCategoryViewModel(
          initCategory: initCategory, catIndex: catIndex);
}
